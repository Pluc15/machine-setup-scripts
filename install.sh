...
echoStep "Linking theme specific configuraion files"
ln -fs "$DOTFILES/themes/current/.config/dunst/dunstrc"                      "$HOME/.config/dunst/dunstrc"
ln -fs "$DOTFILES/themes/current/.config/rofi/rofi-my-dark-theme.rasi"       "$HOME/.config/rofi/rofi-my-dark-theme.rasi"
ln -fs "$DOTFILES/themes/current/.config/Xresources.d/10-theme"              "$HOME/.config/Xresources.d/10-theme"
...
echoStep "Configure current theme"
if [ ! -d "$HOME/.dotfiles/themes/current" ]
then
    $DOTFILES/bin/.theme-selector dva_genji
fi
